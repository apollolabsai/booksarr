...
export default function BookDownloadSelector({
  ...
  return (
    ...
    >
      ...
      {open && hasMultiple && (
        <div className={`absolute ${positionClassName} ${alignClassName} z-40 max-w-[min(20rem,calc(100vw-2rem))] overflow-hidden rounded-xl border border-slate-600 bg-slate-900/98 shadow-2xl ${menuWidthClassName}`}>
          <div className="border-b border-slate-700 px-3 py-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-400">
          ...
          <div className="max-h-72 overflow-y-auto p-1.5">
            {downloadFiles.map((file) => (
              <button
                ...
                className="flex w-full items-start gap-3 rounded-lg px-2.5 py-2 text-left transition-colors hover:bg-slate-800"
              >
